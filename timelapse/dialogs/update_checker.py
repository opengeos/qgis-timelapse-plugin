"""
Update Checker Dialog for Timelapse Plugin
...
GITHUB_REPO = "opengeos/qgis-timelapse-plugin"
GITHUB_BRANCH = "main"
PLUGIN_PATH = "timelapse"
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="timelapse_update_")
            ...
            # The structure will be: repo-main/timelapse/
            extracted_plugin_dir = None
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "timelapse_plugin.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "timelapse_plugin.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("Timelapse Plugin Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("Timelapse Plugin Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"Timelapse Plugin has been updated to version {self.latest_version}.\n\n"
