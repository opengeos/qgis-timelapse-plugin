...
from qgis.PyQt.QtWidgets import (
    QDockWidget, QVBoxLayout, QHBoxLayout, QTabWidget, QWidget,
    QLabel, QLineEdit, QSpinBox, QDoubleSpinBox, QComboBox,
    QCheckBox, QPushButton, QGroupBox, QFormLayout, QFileDialog,
    QProgressBar, QTextEdit, QMessageBox, QFrame, QColorDialog,
    QSizePolicy, QScrollArea
)
from qgis.PyQt.QtGui import QColor, QFont, QIcon
from qgis.core import (
    QgsProject, QgsMapLayer, QgsVectorLayer, QgsRectangle,
    ...
    def run(self):
        ...
        try:
            ...
            if not timelapse_core.initialize_ee(project_id):
                self.error.emit("Failed to initialize Google Earth Engine. Please authenticate first.")
                return
...
class TimelapseDockWidget(QDockWidget):
    ...
    def create_imagery_tab(self):
        ...
        self.imagery_type.addItems(["NAIP", "Landsat", "Sentinel-2", "Sentinel-1", "MODIS NDVI"])
    ...
    def validate_inputs(self):
        ...
        try:
            ...
            QMessageBox.warning(
                self, "Invalid Input",
                "Please specify a valid bounding box."
            )
            return False
    ...
    def get_landsat_bands(self):
        ...
        return band_options.get(self.landsat_bands.currentText(), ['NIR', 'Red', 'Green'])
    ...
    def on_timelapse_finished(self, output_path):
        ...
        # Open the GIF file directly using the system default application
